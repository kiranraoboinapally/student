...
// MasterStudent maps to master_students
type MasterStudent struct {
	...
	StudentPhone     *string    `gorm:"column:student_phone_number" json:"student_phone_number,omitempty"`
...
// ActStudent maps to act_students
...
func (ActStudent) TableName() string {
	return "act_students"
}
