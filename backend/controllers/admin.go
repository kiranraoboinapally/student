...
// CreateUserByAdmin creates a user with arbitrary role (protected by middleware in routes)
func CreateUserByAdmin(c *gin.Context) {
	...
	// optionally: validate role exists in roles table (safe read-only check)
